...
public class StepAppOpenHelper extends SQLiteOpenHelper {
    ...
    public static Map<String, Integer> loadStepsByDate(Context context) {
        ...
        Cursor cursor = database.rawQuery(
                "SELECT day ,COUNT(*) FROM num_steps GROUP BY day ORDER BY day ASC",
                null
        );
        ...
        for (int index = 0; index < cursor.getCount(); index++) {
            ...
            Integer stepsCount = Integer.parseInt(cursor.getString(1));
            stepsByDate.put(day, stepsCount);
            cursor.moveToNext();
        }
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("INSERT INTO " + TABLE_NAME + " (" + KEY_DAY + ", " + KEY_HOUR + ", " + KEY_TIMESTAMP + ") VALUES ('2024-10-30', '10', '2024-10-30T10:00:00Z')");
